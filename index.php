        ...
        <div class="container-fluid">
            <div class="slider-text d-md-flex align-items-center" data-scrollax-parent="true">
                ...
                <div class="one-forth ftco-animate align-self-md-center" data-scrollax=" properties: { translateY: '70%' }">
                    <h1 class="mb-4"> Mobitel Engineering Division for
                        <strong class="typewrite" data-period="4000" data-type='[ "Networking", "Planning", "Operation" ]'>
                <span class="wrap"></span>
              </strong>
                    </h1>
                    <p class="mb-md-5 mb-sm-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Sri Lanka Mobitel Engineering Division is the nation's number one integrated communications service provider and the leading broadband and backbone infrastructure services.</p>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <span class="subheading">Telecommunications service provider</span>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-11">
                    <div class="row">
                        ...
                        <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
                            <div class="block-18 text-center">
                                <div class="text">
                                    <strong class="number" data-number="1587">0</strong>
                                    <span>Telecommunication Sites</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 pr-md-5 aside-stretch py-5 choose">
                    ...
                    <div class="ftco-animate">
                        <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar. Because
                            there were thousands of bad Commas, wild Question Marks and devious Semikoli</p>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <span class="subheading">Our Managers Says</span>
                </div>
            </div>
                    ...
                    <div class="carousel-testimony owl-carousel ftco-owl">
                      ...
                      <i class="icon-quote-left"></i>
                                ...
                                <div class="text text-center">
                                    ...
                                    <p class="name">Lanka Bandara</p>
                                    <span class="position">Assistant Manager</span>
                                </div>
                            </div>
                        </div>
                        <div class="item">
